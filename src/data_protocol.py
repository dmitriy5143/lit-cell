...
This module reuses the causal temporal/flow/structural utilities from
`oz_core.py`, but feeds them external TrackMate-style tables from LaChance et al.
The first gate is deliberately not an OZ claim: it asks whether the constrained
graph decoder can recover a robust neighbour signal in epithelial trajectories.
"""
...
import oz_core as arch  # noqa: E402
